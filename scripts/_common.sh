...
mount_data() {
    ...
    then
        ...
        yunohost service add "home-yunohost.app-$app-data" --unit="mount" --description="Garage Data Mounted"
...
mount_metadata() {
    ...
    then
        ...
        yunohost service add "home-yunohost.app-$app-metadata" --unit="mount" --description="Garage MetaData Mounted"
